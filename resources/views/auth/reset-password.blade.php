        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                ...
                <div class="text-center mb-4">
                    <div class="d-inline-flex align-items-center justify-content-center bg-success rounded-circle mb-3" style="width:64px;height:64px;">
                ...
                <div class="card card-premium">
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('password.update') }}" id="reset-password-form">
                            ...
                            <div class="d-grid">
                                <button type="submit" id="btn-submit" class="btn btn-success btn-premium py-2 fw-semibold">
